...
results_df.columns = ['insta_id','content','data','like','place','tags','img_url']
...
f_list = ['3_1_crawling_yangjae.xlsx']
for fname in f_list:
    fpath = folder + fname
    temp = pd.read_excel(fpath)
    jeju_insta_df = jeju_insta_df.append(temp)

jeju_insta_df.columns =['index_col','insta_id','content','data','like','place','tags','img_url']

# 예제 4-9 중복 데이터 제거하고 저장하기
jeju_insta_df.drop_duplicates(subset = ['insta_id'] , inplace = True)
